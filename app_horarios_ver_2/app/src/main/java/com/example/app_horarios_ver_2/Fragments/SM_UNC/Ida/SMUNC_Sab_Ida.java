 ...
 */
public class SMUNC_Sab_Ida extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.sm_smunc__sab__ida, container, false);

        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_UNC_sab_SMUNC_I);
    ...
    public void loadDatabase() {
        ...
        try {
            ...
            cursor = databaseHelper.QueryData("select * from UNCSMSabIda");
