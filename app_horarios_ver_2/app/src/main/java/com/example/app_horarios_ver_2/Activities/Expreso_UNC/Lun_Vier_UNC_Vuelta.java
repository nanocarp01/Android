...
import com.example.app_horarios_ver_2.Adapters.Expreso_UNC.ViewPagerAdapterExpresoUNCVuelta;
import com.example.app_horarios_ver_2.R;
import com.example.app_horarios_ver_2.ZoomOutPageTransformer;

public class Lun_Vier_UNC_Vuelta extends AppCompatActivity {
    ...
    private ViewPagerAdapterExpresoUNCVuelta adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.expreso_lun__vier__unc__vuelta);
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterExpresoUNCVuelta(getSupportFragmentManager(),  tabLayout.getTabCount());
