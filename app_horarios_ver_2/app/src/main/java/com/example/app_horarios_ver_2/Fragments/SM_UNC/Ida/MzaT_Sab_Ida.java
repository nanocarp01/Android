 ...
 */
public class MzaT_Sab_Ida extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.sm_mza_t__sab__ida, container, false);

        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_MzaT_sab_SMUNC_I);
