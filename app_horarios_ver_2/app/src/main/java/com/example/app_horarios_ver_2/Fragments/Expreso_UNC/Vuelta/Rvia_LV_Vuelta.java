package com.example.app_horarios_ver_2.Fragments.Expreso_UNC.Vuelta;
 ...
 */
public class Rvia_LV_Vuelta extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.exunc_rvia__lv__vuelta, container, false);

        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_Rvia_ExUNC_V);
    ...
    public void loadDatabase() {
        ...
        try {
            ...
            cursor = databaseHelper.QueryData("select * from ExUNCVuelta");
