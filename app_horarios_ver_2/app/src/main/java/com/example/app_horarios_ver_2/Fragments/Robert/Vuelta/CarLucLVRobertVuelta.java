 ...
 */
public class CarLucLVRobertVuelta extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_car_luc_lvrobert_vuelta, container, false);
        recyclerView= (RecyclerView) viewGroup.findViewById(R.id.recycler_CarLucV);
        arrayList.clear();
        loadDatabase();
        return viewGroup;
    }
    ...
    public void loadDatabase(){
        ...
        try {
            cursor = databaseHelper.QueryData("select * from RobertVuelta");
            if (cursor != null) {
