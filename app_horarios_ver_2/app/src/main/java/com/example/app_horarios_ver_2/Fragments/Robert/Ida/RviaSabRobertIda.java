...
public class RviaSabRobertIda extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_rvia_sab_robert_ida, container, false);
        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_Rvia2);
        arrayList.clear();
        loadDatabase();
        return viewGroup;
    }
