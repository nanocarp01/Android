...
public class CarLucSabRobertVuelta extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup =(ViewGroup) inflater.inflate(R.layout.fragment_car_luc_sab_robert_vuelta, container, false);
        recyclerView= (RecyclerView) viewGroup.findViewById(R.id.recycler_CarLucV2);
        arrayList.clear();
        loadDatabase();
        return viewGroup;
    }
    ...
    public void loadDatabase(){
        ...
        try {
            cursor = databaseHelper.QueryData("select * from RobertSabVuelta");
            if (cursor != null) {
