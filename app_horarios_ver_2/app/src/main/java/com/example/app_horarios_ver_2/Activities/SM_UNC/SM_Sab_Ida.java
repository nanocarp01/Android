...
import com.example.app_horarios_ver_2.Adapters.SM_UNC.ViewPagerAdapterSMUNCSabIda;
import com.example.app_horarios_ver_2.R;
import com.example.app_horarios_ver_2.ZoomOutPageTransformer;

public class SM_Sab_Ida extends AppCompatActivity {
    ...
    private ViewPagerAdapterSMUNCSabIda adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sm__sab__ida);
        initView();
        initToolbar();
        initTablayout();
        setupView();
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterSMUNCSabIda(getSupportFragmentManager(),  tabLayout.getTabCount());
