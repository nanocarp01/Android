 ...
 */
public class CarLucDomFerRobertIda extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup =(ViewGroup) inflater.inflate(R.layout.fragment_car_luc_dom_fer_robert_ida, container, false);

        recyclerView= (RecyclerView) viewGroup.findViewById(R.id.recycler_CarLuc3);
    ...
    public void loadDatabase(){
        ...
        try {
            cursor = databaseHelper.QueryData("select * from RobertDomFerIda");
            if (cursor != null) {
