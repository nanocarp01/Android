...
import com.example.app_horarios_ver_2.Adapters.SM_UNC.ViewPagerAdapterSMUNCSabVuelta;
import com.example.app_horarios_ver_2.R;
import com.example.app_horarios_ver_2.ZoomOutPageTransformer;

public class SM_Sab_Vuelta extends AppCompatActivity {
    ...
    private ViewPagerAdapterSMUNCSabVuelta adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sm__sab__vuelta);
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterSMUNCSabVuelta(getSupportFragmentManager(),  tabLayout.getTabCount());
