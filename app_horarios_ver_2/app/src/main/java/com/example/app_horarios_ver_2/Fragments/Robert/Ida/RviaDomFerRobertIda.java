 ...
 */
public class RviaDomFerRobertIda extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup =(ViewGroup) inflater.inflate(R.layout.fragment_rvia_dom_fer_robert_ida, container, false);
        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_Rvia3);
        arrayList.clear();
        loadDatabase();
        return viewGroup;
