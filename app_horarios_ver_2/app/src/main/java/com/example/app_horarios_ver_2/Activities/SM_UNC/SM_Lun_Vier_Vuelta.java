...
import com.example.app_horarios_ver_2.Adapters.SM_UNC.ViewPagerAdapterSMUNCVuelta;
import com.example.app_horarios_ver_2.R;
import com.example.app_horarios_ver_2.ZoomOutPageTransformer;

public class SM_Lun_Vier_Vuelta extends AppCompatActivity {
    ...
    private ViewPagerAdapterSMUNCVuelta adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sm__lun__vier__vuelta);
        initView();
        initToolbar();
        initTablayout();
        setupView();
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterSMUNCVuelta(getSupportFragmentManager(),  tabLayout.getTabCount());
