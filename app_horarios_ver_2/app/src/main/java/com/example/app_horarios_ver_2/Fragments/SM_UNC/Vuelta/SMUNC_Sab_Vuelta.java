package com.example.app_horarios_ver_2.Fragments.SM_UNC.Vuelta;
 ...
 */
public class SMUNC_Sab_Vuelta extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.sm_smunc__sab__vuelta, container, false);

        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_UNC_sab_SMUNC_V);
    ...
    public void loadDatabase() {
        ...
        try {
            ...
            cursor = databaseHelper.QueryData("select * from UNCSMSabVuelta");
