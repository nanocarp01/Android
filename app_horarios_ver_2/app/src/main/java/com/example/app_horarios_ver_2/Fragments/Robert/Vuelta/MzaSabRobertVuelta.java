...
public class MzaSabRobertVuelta extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup=(ViewGroup) inflater.inflate(R.layout.fragment_mza_sab_robert_vuelta, container, false);

        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_view3);
        arrayList.clear();
        loadDatabase();
        return viewGroup;
    }
