...
public class Sab_ida extends AppCompatActivity {
    ...
    private ViewPagerAdapterSabIda adapter;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.robert_sab_ida);
        initView();
        initToolbar();
        initTablayout();
        setupView();
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterSabIda(getSupportFragmentManager(), tabLayout.getTabCount());
