...
import com.example.app_horarios_ver_2.Adapters.Robert.ViewPagerAdapterDomFerVuelta;
...
public class Dom_Fer_Vuelta extends AppCompatActivity {
    ...
    private ViewPagerAdapterDomFerVuelta adapter;


    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.robert_dom_fer_vuelta);
        initView();
        initToolbar();
        initTablayout();
        setupView();
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterDomFerVuelta(getSupportFragmentManager(), tabLayout.getTabCount());
