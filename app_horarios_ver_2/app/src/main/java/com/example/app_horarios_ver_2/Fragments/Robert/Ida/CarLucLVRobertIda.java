...
public class CarLucLVRobertIda extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_car_luc_ida_lv_robert, container, false);
        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_CarLuc);
        arrayList.clear();
        loadDatabase();
        return viewGroup;
    }
