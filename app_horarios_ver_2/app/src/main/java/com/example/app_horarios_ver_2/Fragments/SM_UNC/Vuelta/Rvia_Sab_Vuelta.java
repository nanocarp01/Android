 ...
 */
public class Rvia_Sab_Vuelta extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.sm_rvia__sab__vuelta, container, false);


        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_Rvia_sab_SMUNC_V);
