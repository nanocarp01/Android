...
public class Lun_Vier_Ida extends AppCompatActivity {
    ...
    private ViewPagerAdapterIda adapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.robert_lun_vier_ida);
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterIda(getSupportFragmentManager(), tabLayout.getTabCount());
