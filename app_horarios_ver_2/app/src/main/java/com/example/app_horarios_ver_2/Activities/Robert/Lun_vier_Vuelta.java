...
public class Lun_vier_Vuelta extends AppCompatActivity {
    ...
    private ViewPagerAdapterVuelta adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.robert_lun_vier_vuelta);
        initView();
        initToolbar();
        initTablayout();
        setupView();
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterVuelta(getSupportFragmentManager(), tabLayout.getTabCount());
