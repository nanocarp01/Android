 ...
 */
public class Jun_LV_Expreso_Ida extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_jun__lv__expreso__ida, container, false);

        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_Jun);
    ...
    public void loadDatabase() {
        ...
        try {
            ...
            cursor = databaseHelper.QueryData("select * from ExLVIda");
