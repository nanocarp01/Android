...
import com.example.app_horarios_ver_2.Adapters.Expreso.ViewPagerAdapterExpresoIda;
import com.example.app_horarios_ver_2.R;
import com.example.app_horarios_ver_2.ZoomOutPageTransformer;

public class Ex_Lun_Vier_Ida extends AppCompatActivity {
    ...
    private ViewPagerAdapterExpresoIda adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.expreso_ex__lun__vier__ida);
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterExpresoIda(getSupportFragmentManager(),  tabLayout.getTabCount());
