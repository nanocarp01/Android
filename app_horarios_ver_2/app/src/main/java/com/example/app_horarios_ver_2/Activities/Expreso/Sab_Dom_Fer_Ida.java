...
import com.example.app_horarios_ver_2.Adapters.Expreso.ViewPagerAdapterExpresoSabDomFerIda;
import com.example.app_horarios_ver_2.R;
import com.example.app_horarios_ver_2.ZoomOutPageTransformer;

public class Sab_Dom_Fer_Ida extends AppCompatActivity {
    ...
    private ViewPagerAdapterExpresoSabDomFerIda adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.expreso_sab__dom__fer__ida);
    ...
    public void setupView() {
        adapter = new ViewPagerAdapterExpresoSabDomFerIda(getSupportFragmentManager(),  tabLayout.getTabCount());
